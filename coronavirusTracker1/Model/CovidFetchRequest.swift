...
import Foundation; import Alamofire; import SwiftyJSON;
...
class CovidFetchRequest: ObservableObject {
    ...
    func getCurrentTotal() {
        ...
        AF.request("https://covid-19-data.p.rapidapi.com/totals?format=undefined", headers: headers).responseJSON {
            response in
    ...
    func getAllCountries () {
        ...
        AF.request("https://covid-19-data.p.rapidapi.com/country/all?format=json", headers: headers).responseJSON {
            response in
